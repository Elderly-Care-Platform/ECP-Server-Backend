...
public class AskCategoryResponse implements IResponse {
	...
	public static class AskCategoryEntity {
		...
		public AskCategoryEntity(AskCategory askCategory, User user) {
			...
			long countWithoutSearch = AskCategoryResponse.userProfileRepo.getServiceProvidersByFilterCriteriaCount(null, userTypes, null, null, null, experties,null,null,null,null,false);
			long countWithSearch = AskCategoryResponse.userProfileRepo.getServiceProvidersByFilterCriteriaCount(AskCategoryResponse.searchTxt, userTypes, null, null, null, experties,null,null,null,null,false);
